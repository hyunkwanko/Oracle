...
insert into users values ('demo','pknuit','manager');
insert into users values ('foo','pknuit','executive');
insert into users values ('khk','khk','executive');

select * from users;

commit; /* 커밋을 안하면 트랜잭션이 롤백하기 때문에 반드시 커밋을 해야한다. */